  ...
  window.SAA_ESTRUTURA = {
    ...
    sugerida: {
      ...
      notas: [
        ...
        "O organograma da minuta mostra cargo, não pessoa: cada caixa traz o nível e o cargo que o ocupa — Diretoria (DAS-4), Coordenação (DAS-3) e Núcleo (equipe terceirizada) —, e o único nome no desenho é o do titular de hoje na Superintendência. Enquanto a designação depende de ato, nomear quem ocupa o quê daria por decidido o que não está; o quadro de cada unidade continua na lista, que é onde ele é informação e não anúncio.",
        "O Núcleo de Banco de Dados aparece como terceirizado por seguir a regra dos Núcleos, mas mantém hoje dois analistas efetivos: a confirmar se ele passa a ser operado por contrato ou se a regra abre exceção para ele.",
